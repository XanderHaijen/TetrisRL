...
class FirstVisitMonteCarloForTetris(Algorithm):
    def __init__(self, value_function: dict = None, C: dict = None):
        """
    ...
    def train(self, learning_rate: Callable[[int], float], nb_episodes=1000,
              start_episode=0, first_visit: bool = True, gamma: float = 1) -> None:
        """
        ...
        for episode in range(1, nb_episodes + 1):
            ...
            while not done:
                ...
                if not first_visit or (old_state, old_action) not in visited:

                    # Collect C(s,a). Add to dict if this is the first occurrence
                    ...
                    # compute new value using incremental implementaton (Sutton & Barto, Chapter 2)

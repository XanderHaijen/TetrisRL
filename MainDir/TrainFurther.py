...
path_to_model = "/scratch/leuven/343/vsc34339/RLData/alpha_0.05_gamma_0.9/StateValueModel/model.pickle"
...
os.mkdir(data_path)
model_path = os.path.join(name_path, "StateValueModel", "2nd_model.pickle")
